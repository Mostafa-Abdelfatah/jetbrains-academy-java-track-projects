...
public class Zoo {
    public static void main(String[] args) {
        ...
        System.out.println("Please enter the number of the habitat you would like to view: from 0 to 5 and enter exit to stop");
        while (scanner.hasNextInt()) {

            int animalNumber = scanner.nextInt();
            System.out.println();
            System.out.println(animals[animalNumber]);
            System.out.println("Please enter the number of the habitat you would like to view: from 0 to 5 and enter exit to stop");
